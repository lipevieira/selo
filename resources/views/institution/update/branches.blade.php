    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-warning btn-sm" id="btnPrepareUpdate" data-url="{{route('branche.show')}}"
                        idEdit="{{$branche->id}}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="btnConfirmSave"
                        data-url="{{route('branche.store')}}">Salvar</button>
                    <button type="button" class="btn btn-success" id="btnUpdate"
                        data-url="{{route('branche.update')}}">Atualizar</button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="btnConfirmarExclusao"
                        data-url="{{route('branche.delete')}}">Confirmar</button>
                </div>
            </div>
        </div>
    </div>
