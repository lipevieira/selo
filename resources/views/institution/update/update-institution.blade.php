...
<div class="container">
    ...
    <form method="POST" id="formUpdate">
        ...
        @endif
        {{-- Verificando se a instituição mandou os documentos --}}
        @if ($institutions->documents->count() <= 2) <div class="alert alert-danger">
            Verificamos que ainda faltam os documentos, <a href="{{ route('doc.index') }}">click para enviá-los</a>
</div>
@endif
            ...
            <div class="panel-body">
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control " name="name" id="name" value="{{$institutions->name}}">
                    </div>
                    <div class="col-md-4 mb-3 ">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="cnpj" value="{{$institutions->cnpj}}" name="cnpj"
                            readonly="readonly">
                    </div>
                    <div class="col-md-4 mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="uf" value="{{ $institutions->uf }}" name="uf"
                            readonly="readonly">
                    </div>
                    <div class="col-md-4 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="email_two">Autoriza a divulgação das ações do Cronograma pela SEMUR? <small class="asterisco-input">*</small></label>
                        <select class="form-control form-control-sm" name="authorization">
                        <option>{{$institutions->authorization}}</option>
            ...
            <div class="panel-body">
                ...
                <div align="center">
                    <button type="button" name="btn_previous_parceiras" id="btn_previous_parceiras"
                        class="btn btn-default btn-lg">Anterior</button>
                    <button type="button" name="btn_next_parceiras" id="btn_next_parceiras" class="btn btn-info btn-lg"
        ...
        <div class="panel panel-default">
            <div class="panel-heading"> PLANO DE TRABALHO DE DIVERSIDADE ÉTNICO-RACIAL
                <div class="legends-forms">
                    <strong>LEGENDA DO FORMULÁRIO: Campos obrigatórios </strong><small
                        class="asterisco-input-ogrigatorio">*</small>
                    <strong> Campos Opicionais</strong>
                </div>
            </div>
            <div class="panel-body">
                <!-- Inicio dos inputs -->
                <h4>RESULTADOS ESPERADOS<small class="asterisco-input-ogrigatorio">*</small></h4>
                <strong>
