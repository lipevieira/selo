                ...
                <div class="panel-body">
                    ...
                    <div class="form-textarea">
                        <div class="form-group">
                            ...
                            <textarea class="form-control class_textarea" id="action_plan" rows="3" name="action_plan">{{$institutions->action_plan}}</textarea>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="qtd_caracteres">
                        ...
                        <textarea class="form-control class_textarea" id="partners" rows="3" name="partners">{{$institutions->partners}}</textarea>
                    </div>
                    <!-- Final dos inputs -->
                    <br />
                    <div align="center">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="qtd_caracteres">
                        ...
                        <textarea class="form-control class_textarea" id="methodology" rows="3" name="methodology">{{$institutions->methodology}}</textarea>
                    </div>
                    <!-- Final dos Inpust -->
                    <br />
                    <div align="center">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="qtd_caracteres">
                        ...
                        <textarea class="form-control class_textarea" id="result" rows="3" name="result">{{$institutions->result}}</textarea>
                    </div>
                    <!-- Final dos Inputs -->
                    <br />
                    <div align="center">
